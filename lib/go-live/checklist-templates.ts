...
export const CORE_CHECKLIST: ChecklistTemplate[] = [
  ...
  { key: "test_order", title: "Test order created", description: "An end-to-end test order has been completed in KitchenOS.", stage: "PRODUCTION_VALIDATION", category: "kitchen", required: true, autoValidated: true, weight: 3, blockerSeverity: "CRITICAL", actionRoute: "/dashboard/orders/new" },
  ...
  { key: "analytics_firing", title: "Analytics events firing", description: "Storefront and KitchenOS analytics produce events.", stage: "FINANCIAL_VALIDATION", category: "analytics", required: false, autoValidated: true, weight: 1, blockerSeverity: "HIGH_RISK", actionRoute: "/dashboard/analytics" },
