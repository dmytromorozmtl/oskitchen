...
export const ERROR_BOUNDARY_TEMPLATE_IMPORT =
  "@/components/dashboard/error-boundary-template" as const;

export const ERROR_STATE_PRIMITIVE_PATTERN =
  /ErrorState|ApiErrorState|RouteError|AiFeatureApiError|ErrorBoundaryTemplate/;
