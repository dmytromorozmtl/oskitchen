...
export const NAV_MATURITY_HIDE_RULES: readonly NavMaturityHideRule[] = [
  ...
  { prefix: "/dashboard/go-live", exposure: "hidden_default", matrixRef: "Go-live projects — Onboarding Hub secondary path" },
  { prefix: "/dashboard/implementation", exposure: "hidden_default", matrixRef: "Implementation — Onboarding Hub secondary path" },
