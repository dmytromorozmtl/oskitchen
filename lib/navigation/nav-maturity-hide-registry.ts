...
export const NAV_MATURITY_HIDE_RULES: readonly NavMaturityHideRule[] = [
  ...
  { prefix: "/dashboard/integrations/uber-direct", exposure: "placeholder", matrixRef: "Uber / DoorDash provider surfaces" },
  { prefix: "/dashboard/routes/uber-direct", exposure: "placeholder", matrixRef: "Uber / DoorDash provider surfaces" },
