...
export const FINAL_NAVIGATION_GROUPS: NavGroupDef[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/dashboard/meal-prep", labelKey: "nav.mealPrepOs", icon: CalendarClock },
      { href: "/dashboard/meal-plans", labelKey: "nav.mealSubscriptions", icon: Repeat },
      { href: "/dashboard/catering", labelKey: "nav.cateringOs", icon: UtensilsCrossed },
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/dashboard/accounting/gl-sync", labelKey: "nav.glDepthAccounting", icon: BookOpen },
