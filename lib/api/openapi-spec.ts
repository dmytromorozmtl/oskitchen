...
import { DEVELOPER_API_SANDBOX_BASE_URL } from "@/lib/developer/developer-api-sandbox-p2-75";
...
export function buildOpenApiDocument(): Record<string, unknown> {
  ...
  return {
    ...
    servers: [
      { url: "https://os-kitchen.com", description: "Production" },
      { url: DEVELOPER_API_SANDBOX_BASE_URL, description: "Sandbox" },
    ],
    tags,
    paths,
    components: {
