...
export const COMPARE_PAGES: ComparePageContent[] = [
  ...
  },
  {
    ...
    subheadline: `${MARKETMAN_POSITIONING_PRIMARY_LINE} MarketMan wins on invoice OCR and vendor item masters. OS Kitchen ties shortage signals to real orders plus B2B marketplace purchasing in one tenant.`,
  ...
  {
    slug: 'marginedge',
    path: '/compare/marginedge',
    metaTitle: 'OS Kitchen vs MarginEdge — Invoice AI & Food Cost Comparison',
    metaDescription:
      'MarginEdge vs OS Kitchen: dedicated invoice OCR product vs invoice AI inside a full kitchen operating system with POS, KDS, and production.',
    eyebrow: 'OS Kitchen vs MarginEdge',
    headline: 'MarginEdge for invoice AI — OS Kitchen for the whole line',
    subheadline: `${MARGINEDGE_POSITIONING_PRIMARY_LINE} MarginEdge wins on invoice OCR depth and price-variance alerts. OS Kitchen embeds invoice capture inside POS, KDS, production, and B2B marketplace purchasing.`,
    methodology: 'Compares invoice/AP modules honestly; verify MarginEdge OCR accuracy tiers separately.',
    comparisonTag: 'Invoice AI vs ops OS',
    comparison: {
      title: 'MarginEdge vs OS Kitchen',
      competitorALabel: 'MarginEdge',
      competitorBLabel: 'QuickBooks + POS',
      rows: [
        { feature: 'Invoice OCR', kitchenos: '✅ BETA module', competitorA: '✅ Core product', competitorB: 'Manual' },
        { feature: 'Price variance alerts', kitchenos: 'Growing AP capture', competitorA: '✅ Strong', competitorB: '❌' },
        { feature: 'POS + KDS', kitchenos: '✅ Included', competitorA: '❌ Not primary', competitorB: 'Separate' },
        { feature: 'Production board', kitchenos: '✅ Native', competitorA: '❌', competitorB: '❌' },
        { feature: 'B2B marketplace', kitchenos: '✅ BETA', competitorA: '❌', competitorB: '❌' },
      ],
    },
    disclaimer: 'MarginEdge is stronger when invoice automation is the only buying criteria. OS Kitchen is stronger when scanned invoices must feed live kitchen ops.',
    whenToChoose: [
      { title: 'Choose MarginEdge when', body: 'Finance-led teams need best-in-class invoice OCR and AP workflows as a standalone product.' },
      { title: 'Choose OS Kitchen when', body: 'You want invoice AI inside POS, production, and marketplace — not another back-office silo.' },
    ],
    faqs: [
      { q: 'Can invoice data sync both ways?', a: 'Many operators start with OS Kitchen invoice capture and export to accounting — evaluate integration maturity before dual-vendor stacks.' },
    ],
    primaryCta: { label: 'See invoice scanner', href: '/solutions/restaurants?utm_source=compare&utm_medium=organic&utm_campaign=marginedge' },
  },
  {
    slug: 'deliverect',
