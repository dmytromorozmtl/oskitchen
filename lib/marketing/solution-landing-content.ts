...
export const RICH_SOLUTION_LANDING: Record<RichSolutionSlug, RichSolutionLanding> = {
  'meal-prep': {
    ...
    subtitle:
      'When preorders live in three tabs, production cooks wrong quantities — and mispacks erode trust at pickup. OS Kitchen connects menu cutoffs, confirmed orders, production board, and packing lanes in one flow.',
    features: [
      {
  ...
  'ghost-kitchens': {
    ...
    subtitle:
      'Ghost kitchens lose leverage when every channel runs separately. OS Kitchen unifies tickets in one Order Hub, routes shared production, and surfaces brand-level P&L — with honest BETA labels where integrations are still maturing.',
    features: [
      {
