...
export const PUBLIC_ROADMAP_OUT_OF_SCOPE: PublicRoadmapItem[] = [
  ...
  },
  {
    ...
    description: 'Online-first pilot — offline PCI path not sales-safe.',
    status: 'deferred',
  },
  {
    id: 'doordash-native',
  ...
  },
  {
    ...
    description: 'Software counter UX today — reader SDK is roadmap-only.',
    status: 'deferred',
  },
];

export const PUBLIC_ROADMAP_HONESTY_DISCLAIMER =
  'Roadmap items reflect June 2026 engineering status — not a delivery guarantee. BETA labels stay until certification gates pass. 0 signed founding customers; design partner program open.';
