export const LANDING_FAQS = [
  ...
  },
  {
    ...
    a: 'The 14-day trial includes core POS, kitchen display, table management, and production workflows on the plan you select. No credit card is required to start.',
  },
  {
    q: 'Can I use QR ordering at the table?',
  ...
  },
  {
    ...
    a: 'Stripe powers subscription billing and hosted storefront checkout when you configure keys. Counter POS supports cash and external-terminal workflows; native Stripe Terminal hardware drivers are not integrated today.',
  },
  {
    q: 'Are Uber Eats or DoorDash integrations included?',
    a: 'Marketplace adapters are available on Team when partner access and credentials are verified. We label integrations as live, setup-ready, or partner-required — never implied as on for every account.',
  },
] as const;
