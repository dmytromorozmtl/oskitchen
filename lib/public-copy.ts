...
export const solutionPages = {
  ...
  commissary: {
    title: "Commissary kitchen operations",
    description:
      "Schedule shared production, route tenant orders, and coordinate B2B supply from one commissary dashboard.",
    whoFor: "Shared kitchens, commissary operators, and multi-tenant production facilities.",
    pain: [
      "Tenant orders arrive in separate silos",
      "Production schedules lag real demand",
      "B2B supply and commissary-as-vendor workflows are spreadsheet-driven",
    ],
    workflow: "Ingest tenant orders -> batch production -> label and route -> optional B2B fulfillment.",
    modules: ["Order hub", "Production", "Packing", "Marketplace", "Integration health"],
    limitations: [
      "B2B marketplace checkout is BETA — disclose scope in tenant-facing materials.",
      "Full multi-tenant billing isolation is enterprise roadmap.",
    ],
  },
  "ghost-kitchens": {
