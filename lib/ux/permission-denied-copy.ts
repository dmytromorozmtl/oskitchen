...
export type PermissionDeniedSurfaceDef = {
  ...
  /** Optional override when RBAC key alone is too generic (owner-only surfaces). */
  description?: string;
};
...
> = {
  ...
  command_center: {
    ...
    permissionKey: "reports.read.operations",
    description:
      "Command Center is limited to workspace owners and leadership roles. Ask an owner to update your role, or use Today for daily operations.",
    primaryHref: "/dashboard/today",
    primaryLabel: "Back to Today",
  ...
  staff_schedule: {
    ...
    primaryHref: "/dashboard/today",
    primaryLabel: "Back to Today",
    secondaryHref: "/dashboard/staff",
    secondaryLabel: "Staff hub",
  },
  analytics_hub: {
    id: "analytics_hub",
    title: "Analytics",
  ...
  ai: {
    ...
    primaryHref: "/dashboard/today",
    primaryLabel: "Back to Today",
    secondaryHref: "/dashboard/copilot",
  ...
  costing: {
    ...
    primaryHref: "/dashboard/today",
    primaryLabel: "Back to Today",
    secondaryHref: "/dashboard/inventory",
  ...
  storefront: {
    id: "storefront",
    title: "Storefront",
    permissionKey: "storefront.manage",
    primaryHref: "/dashboard/today",
    primaryLabel: "Back to Today",
    secondaryHref: "/dashboard/storefront",
    secondaryLabel: "Open storefront",
  },
};
...
export function resolvePermissionDeniedSurface(
  ...
  return {
    ...surface,
    description:
      surface.description ?? buildPermissionDeniedDescription(surface.permissionKey),
  };
}
