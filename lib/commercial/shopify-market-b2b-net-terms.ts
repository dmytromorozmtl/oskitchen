export const SHOPIFY_MARKET_B2B_NET_TERMS_HONESTY =
  "Shopify B2B net terms and PO numbers enrich channel staging and kitchen orders — operators can require PO before approve; invoice draft generation is Phase 17.";
