export const SHOPIFY_MARKET_B2B_PAYMENT_COLLECTION_HONESTY =
  "Operators mark B2B net-terms invoice drafts paid in Order Hub after collecting payment outside Shopify — buyers can also pay via hosted pay link when portal is enabled.";
