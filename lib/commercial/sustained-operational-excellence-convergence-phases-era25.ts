...
export const SUSTAINED_OPERATIONAL_EXCELLENCE_CONVERGENCE_ERA25_TRACKED_ENV_KEYS = [
  "SUSTAINED_OPERATIONAL_EXCELLENCE_CONVERGENCE_ERA25_ATTESTED",
  "SUSTAINED_OPERATIONAL_EXCELLENCE_CONVERGENCE_ERA25_REPORT_REVIEWED",
] as const;

export function detectSustainedOperationalExcellenceConvergenceEra25Started(
  env: NodeJS.ProcessEnv = process.env,
): boolean {
  return SUSTAINED_OPERATIONAL_EXCELLENCE_CONVERGENCE_ERA25_TRACKED_ENV_KEYS.some((key) =>
