...
export async function briefingTelemetryListWhereForOwner(
  ownerUserId: string,
): Promise<Prisma.BriefingTelemetryWhereInput> {
  return resolveOwnerScopedWhere(ownerUserId) as Prisma.BriefingTelemetryWhereInput;
}

export async function productionStationListWhereForOwner(
  ownerUserId: string,
): Promise<Prisma.ProductionStationWhereInput> {
...
export async function storefrontInventoryItemListWhereForOwner(
  ...
  return resolveOwnerScopedWhere(ownerUserId) as Prisma.StorefrontInventoryItemWhereInput;
}

export async function capitalPartnerReferralListWhereForOwner(
  ownerUserId: string,
): Promise<Prisma.CapitalPartnerReferralWhereInput> {
  return resolveOwnerScopedWhere(ownerUserId) as Prisma.CapitalPartnerReferralWhereInput;
}
