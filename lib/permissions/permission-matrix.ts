...
export const STAFF_TEMPLATE_CAPABILITIES: Record<StaffRoleType, readonly CapabilityKey[]> = {
  ...
  PACKER: [CAPABILITY.ordersRead, CAPABILITY.packingVerify, CAPABILITY.reportsReadOperations],
  DRIVER: [CAPABILITY.ordersRead, CAPABILITY.routesAssign, CAPABILITY.reportsReadOperations],
  CUSTOMER_SERVICE: [
    CAPABILITY.ordersRead,
    CAPABILITY.ordersWrite,
    CAPABILITY.posOperate,
