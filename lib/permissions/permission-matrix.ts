...
export const STAFF_TEMPLATE_CAPABILITIES: Record<StaffRoleType, readonly CapabilityKey[]> = {
  ...
  PREP_COOK: [CAPABILITY.ordersRead, CAPABILITY.productionRun],
  LINE_COOK: [CAPABILITY.ordersRead, CAPABILITY.productionRun],
  PACKER: [CAPABILITY.ordersRead, CAPABILITY.packingVerify],
  DRIVER: [CAPABILITY.ordersRead, CAPABILITY.routesAssign],
  CUSTOMER_SERVICE: [CAPABILITY.ordersRead, CAPABILITY.ordersWrite],
  CATERING_COORDINATOR: [CAPABILITY.ordersRead, CAPABILITY.ordersWrite],
