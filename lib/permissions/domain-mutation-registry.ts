...
export const DOMAIN_MUTATION_HELPERS: readonly DomainMutationHelperEntry[] = [
  ...
  },
  {
    ...
    backing: { kind: "canonical", permissions: ["orders.manage"] },
    auditsDenials: true,
  },
  {
    id: "pos_mutations",
    domain: "pos",
    module: "lib/pos/require-pos-mutation.ts",
    entrypoint: "requirePosMutation",
    backing: {
      kind: "canonical",
      permissions: [
        "pos.access",
  ...
  {
    id: "packing_mutations",
    domain: "packing",
    module: "lib/packing/require-packing-mutation.ts",
    entrypoint: "requirePackingMutation",
    backing: { kind: "canonical", permissions: ["packing.manage"] },
    auditsDenials: true,
  },
  {
