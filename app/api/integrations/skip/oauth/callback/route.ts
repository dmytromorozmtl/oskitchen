...
import { completeSkipOAuth, verifySkipOAuthState } from "@/services/integrations/skip-live-service";
...
export async function GET(request: Request) {
  ...
  const livePath = "/dashboard/integrations/skip/live";
  ...
  const verified = verifySkipOAuthState(state);
  ...
  const result = await completeSkipOAuth({
