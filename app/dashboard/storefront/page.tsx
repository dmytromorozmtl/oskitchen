...
export default async function StorefrontAdminPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      ...
      <Card className="border-border/80 shadow-sm" data-testid="storefront-publish-panel">
        <CardHeader>
          ...
          <form className="space-y-6" action={upsertStorefrontSettingsFormAction}>
            <div className="flex items-center justify-between rounded-xl border border-border/80 px-4 py-3">
              ...
              <input
                ...
                type="checkbox"
                value="on"
                data-testid="storefront-published-checkbox"
            ...
            <div className="flex items-center justify-between rounded-xl border border-border/80 px-4 py-3">
              ...
              <input
                ...
                type="checkbox"
                value="on"
                data-testid="storefront-enabled-checkbox"
            ...
            <Button type="submit" className="rounded-full" data-testid="storefront-save-btn">
              Save storefront
            </Button>
          </form>
          ) : null}
