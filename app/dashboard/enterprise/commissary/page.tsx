...
export const metadata: Metadata = {
  ...
  description: "Production, purchasing, delivery, and distribution for commissary operators.",
};
    ...
    return (
      <Card className="border-amber-300/60 bg-amber-50/40 shadow-none dark:bg-amber-950/20">
        <CardHeader>
          ...
          <CardDescription>
            Configure locations and production plans to run hub fulfillment operations.
          </CardDescription>
        </CardHeader>
      </Card>
    );
