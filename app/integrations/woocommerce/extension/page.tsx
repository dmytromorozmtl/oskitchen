...
export const metadata: Metadata = marketingPageMetadata({
  title: "WooCommerce Extension Readiness — KitchenOS",
...
export default function WooCommerceExtensionPage() {
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-16 text-sm leading-relaxed text-muted-foreground sm:px-6">
      ...
      <p>
        KitchenOS connects with WooCommerce REST API keys and signed webhooks — no GPL plugin is
        strictly required because credentials are entered into KitchenOS directly. A future
      ...
      <section className="space-y-2">
        ...
        <ol className="list-decimal space-y-1 pl-5">
          ...
          <li>Paste keys into KitchenOS WooCommerce card.</li>
