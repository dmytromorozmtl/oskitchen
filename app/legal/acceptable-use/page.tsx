...
export const metadata: Metadata = marketingPageMetadata({
  ...
  description:
    "OS Kitchen acceptable use guidelines for operators, integrations, and customer-facing content.",
  ...
  return (
    <PublicShell>
      <main className="mx-auto max-w-3xl space-y-6 px-4 py-16 sm:px-6">
        ...
        <p>
          Do not use OS Kitchen to store unlawful content, abuse integrations, scrape platforms
        ...
        <p>OS Kitchen may suspend access for security abuse, fraudulent activity, or harmful behavior.</p>
