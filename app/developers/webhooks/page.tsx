...
export default function DeveloperWebhooksPage() {
  return (
    <PublicShell>
      <Hero eyebrow="Webhooks roadmap" title="Future event subscriptions for partners." description="OS Kitchen already processes provider webhooks. Customer-facing outbound webhook subscriptions are planned, not live." />
      <FeatureGrid items={[
