...
import {
  BRIEFING_FIRST_NARRATIVE_CLASS,
  BRIEFING_FIRST_NARRATIVE_TEST_ID,
  BRIEFING_FIRST_NARRATIVE_WRAPPER_CLASS,
    ...
    <section className="space-y-4" data-testid="owner-daily-briefing-hero">
      ...
      <Card className={nextActionCardClass(nextAction.tone)}>
        ...
        <CardContent className="space-y-4">
          <div
            className={BRIEFING_FIRST_NARRATIVE_WRAPPER_CLASS}
            data-testid={BRIEFING_FIRST_NARRATIVE_TEST_ID}
          >
            <p className={BRIEFING_FIRST_NARRATIVE_CLASS}>{briefingNarrative.formatted}</p>
          </div>
