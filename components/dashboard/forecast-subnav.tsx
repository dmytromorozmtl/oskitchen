...
const LINKS: { href: string; label: string; match?: "exact" | "prefix" }[] = [
  { href: "/dashboard/forecast", label: "Overview", match: "exact" },
  { href: "/dashboard/forecast/new", label: "Run forecast" },
  { href: "/dashboard/forecast/history", label: "History" },
  { href: "/dashboard/forecast/settings", label: "Settings" },
];
