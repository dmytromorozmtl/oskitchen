  ...
  return (
    <div className="space-y-8">
      <div
        ...
        data-testid={MOBILE_TODAY_STICKY_HEADER_TEST_ID}
        aria-labelledby={TODAY_VOICEOVER_PAGE_TITLE_ID}
      >
        <div>
          <div className="flex flex-wrap items-center gap-2">
            <h1 id={TODAY_VOICEOVER_PAGE_TITLE_ID} className="text-3xl font-semibold tracking-tight">
              Today
            </h1>
            {modeLabel ? (
          ...
          <p className="sr-only" data-testid={TODAY_VOICEOVER_SR_HINT_TEST_ID}>
            {TODAY_VOICEOVER_SR_NAV_HINT}
          </p>
        </div>
