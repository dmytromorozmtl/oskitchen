  ...
  return (
    <div className="h-[260px] w-full rounded-xl border border-border/70 bg-card/80 p-4 shadow-sm">
      <div className="mb-4 flex items-center justify-between">
        <div>
          <p className="text-sm font-semibold">Fulfillment throughput</p>
        ...
        <AreaChart data={fulfillmentTrend}>
          <defs>
            <linearGradient id="fillKitchen" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="#286ab8" stopOpacity={0.35} />
              <stop offset="95%" stopColor="#286ab8" stopOpacity={0} />
            </linearGradient>
          </defs>
