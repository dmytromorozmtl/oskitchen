...
export function IntegrationHealthP0TrustBannerPanel(props: {
  ...
  return (
    <Card
      id={INTEGRATION_HEALTH_P0_TRUST_BANNER_ANCHOR.slice(1)}
    ...
    >
      ...
      <CardContent className="space-y-3">
        ...
        {banner.missingEnvVars.length > 0 ? (
          <p className="font-mono text-xs text-muted-foreground" data-testid="integration-health-p0-missing-env">
            Missing: {banner.missingEnvVars.join(", ")}
          </p>
        ) : null}
