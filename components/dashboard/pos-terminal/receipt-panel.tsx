...
import { posCheckoutButtonClass } from "@/lib/pos/touch-targets";
    ...
    <div className="space-y-4" data-testid="pos-receipt-panel">
      <div className="rounded-xl border border-border/80 bg-muted/20 px-3 py-3 text-sm">
        ...
        <div className="mt-2 flex items-center justify-between gap-2 border-t border-border/60 pt-2">
          ...
          <span className="text-lg font-semibold tabular-nums">${props.amountDue.toFixed(2)}</span>
        </div>
      </div>
      ...
      >
        <Button
          ...
          className={cn(posCheckoutButtonClass, props.speedMode && "min-h-16 h-16 text-xl")}
