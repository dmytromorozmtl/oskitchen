...
import { POS_VOICEOVER_CART_REGION_LABEL } from "@/lib/design/a11y-voiceover-sweep-policy";
import {
...
export function CartPanel({
  ...
  return (
      <Card
        className={posTabletCartPanelClass(p.layoutOrientation, p.tabletMode)}
        aria-label={POS_VOICEOVER_CART_REGION_LABEL}
      >
