...
export function MarketLeaderPositioningConvergenceEra25Strip(props: {
  ...
  return (
    <Card
      ...
      data-testid="market-leader-positioning-convergence-era25-strip"
    >
      <CardHeader className="pb-3">
        <div className="flex flex-wrap items-center gap-2">
          <CardTitle className="text-base">Market leader positioning (era25)</CardTitle>
        ...
        <CardDescription>
          Honest pillars —{" "}
          {slice.seriesAConvergenceReady
            ? "Series A convergence ready"
            : "awaiting Series A convergence"}
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-2 text-sm">
        ...
        >
          Open market leader convergence on platform ops
        </Link>
      </CardContent>
    </Card>
  );
