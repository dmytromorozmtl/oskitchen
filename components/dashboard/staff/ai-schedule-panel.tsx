...
export function AiSchedulePanel({ weekStartIso, canManage, initialPlan = null }: Props) {
  ...
  return (
    <div className="space-y-4" data-testid="labor-forecast-panel">
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Labor forecast — 7shifts parity</CardTitle>
          <p className="text-sm text-muted-foreground">
            Deep scheduling AI: demand-by-day-of-week, headcount recommendations, labor % targets,
            and one-click draft shifts for the week of {weekStartIso}.
          </p>
        </CardHeader>
      ...
      {plan && (
        <>
          <div
            ...
            data-testid="labor-forecast-summary"
          >
            <Card>
          ...
          <div className="overflow-x-auto rounded-lg border" data-testid="labor-forecast-demand-table">
