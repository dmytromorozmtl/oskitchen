...
import { ArrowRight, LayoutDashboard, Truck } from "lucide-react";
    ...
    <div className="space-y-6" data-testid="driver-role-panel">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Delivery signals for today&apos;s routes</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Ranked delivery priorities</CardDescription>
          </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{snapshot.summary.shortcutCount} delivery surfaces</CardDescription>
        </CardHeader>
