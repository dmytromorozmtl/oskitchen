...
type Props = {
  snapshot: ChefRoleUiSnapshot;
};

export function ChefRolePanel({ snapshot }: Props) {
  return (
    <div className="space-y-6" data-testid="chef-role-panel">
      <Card className={ROLE_HERO_CARD_CLASS.chef}>
        <CardHeader>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Kitchen-pack signals from today&apos;s briefing</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Ranked line priorities</CardDescription>
          </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{snapshot.summary.shortcutCount} kitchen line surfaces</CardDescription>
        </CardHeader>
