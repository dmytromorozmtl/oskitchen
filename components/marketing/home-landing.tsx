...
import { PositioningReformulationStrip } from "@/components/marketing/positioning-reformulation-strip";
    ...
    <main>
        ...
        <section className="dark-section section" style={{ paddingTop: "var(--space-20)" }}>
          <div className="container" style={{ textAlign: "center" }}>
            ...
            <PositioningReformulationStrip
              variant="dark"
              className="reveal visible mt-12"
            />
