    ...
    >
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-center text-sm text-muted-foreground">
          Ghost kitchen, commissary, and meal-prep operators: start with the{" "}
          <strong className="font-medium text-foreground">{DESIGN_PARTNER_PROGRAM_NAME}</strong>{" "}
          (free for {DESIGN_PARTNER_PROGRAM_DURATION_DAYS} days), graduate to a{" "}
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-3">
          <Card className="border-primary/30 lg:col-span-1">
            <CardHeader>
              ...
              <CardDescription>
                {DESIGN_PARTNER_LOI_SKU.sku} · free for {DESIGN_PARTNER_PROGRAM_DURATION_DAYS} days
              </CardDescription>
              <p className="pt-1 text-2xl font-semibold">Free for 90 days</p>
            </CardHeader>
