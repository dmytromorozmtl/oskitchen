...
export const WEBHOOK_SIGNATURE_DETECTORS = [
  ...
  { id: "verify_skip_hmac", pattern: /\bverifySkipWebhookSignature\s*\(/ },
  { id: "verify_opentable_hmac", pattern: /\bverifyOpenTableWebhookSignature\s*\(/ },
  { id: "verify_resy_hmac", pattern: /\bverifyResyWebhookSignature\s*\(/ },
