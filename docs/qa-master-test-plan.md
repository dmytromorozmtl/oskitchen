...
4. ~~RBAC wave 4 batch 1~~ — `test:ci:rbac-wave4` (routes, copilot, demo, feedback, integration menu sync, production calendar, holiday packages); batch 2 residuals remain
