...
3. upload/media malicious file denial coverage — storefront media and kitchen raster uploads covered by unit tests; storefront form attachments and E2E denial matrix still open
