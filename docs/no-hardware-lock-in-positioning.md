...
| **Kitchen / chit printer** | ⚠️ Browser print today | Same browser-print path; native ESC/POS adapters **deferred** — not a teased hardware launch |
| **Cash drawer** | ❌ Manual workflow | Auto kick via printer pulse **deferred** |
| **Customer display** | ❌ Not implemented | Secondary customer display **deferred** |
