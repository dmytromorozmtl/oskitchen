...
**Related:** [`soc2-readiness-assessment.md`](./soc2-readiness-assessment.md) · [`SOC2_ROADMAP_Q4.md`](./SOC2_ROADMAP_Q4.md) · [`enterprise-procurement-pack.md`](./enterprise-procurement-pack.md) · [`eu-data-residency-roadmap.md`](./eu-data-residency-roadmap.md)
...
- [`eu-data-residency-roadmap.md`](./eu-data-residency-roadmap.md) — EU/EEA hosting roadmap (Absolute Final #87)
