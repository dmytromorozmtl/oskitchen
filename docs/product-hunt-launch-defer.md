...
**Updated:** 2026-06-03  
**Parent:** [`series-a-hold-notice.md`](./series-a-hold-notice.md) · [`press-release-first-design-partner.md`](./press-release-first-design-partner.md) · [`forbidden-claims-training.md`](./forbidden-claims-training.md) · [`product-hunt-launch-prep.md`](./product-hunt-launch-prep.md) · [`trust`](/trust)
...
7. Archive listing copy + screenshot set in `artifacts/product-hunt-launch/` (see [`product-hunt-launch-prep.md`](./product-hunt-launch-prep.md)).
...
| [`product-hunt-launch-prep.md`](./product-hunt-launch-prep.md) | T-minus timeline + launch-day runbook (Absolute Final #85) |
