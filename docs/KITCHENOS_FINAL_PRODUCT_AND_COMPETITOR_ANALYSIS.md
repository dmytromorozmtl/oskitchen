...
- Multi-location meal prep and catering with real recurring orders.  
- Hybrid cafés/bakeries with POS + preorder + production.  
- Ghost kitchens that already use Shopify/Woo and need **ops truth**.

### Weak ICPs (initially)

- Full-service chains needing deep table management + complex checks.  
- Operators expecting **payroll + GL** replacement day one.  
- Anyone requiring **SOC2 report** in procurement **before** you have one.

---

## Packaging and pricing (strategy-level)

- **Packaging:** Core ops (orders + hub + production + packing) + optional modules (storefront, advanced analytics, platform admin).  
- **Pricing:** Seat + location + GMV-sensitive components; keep integration costs visible (avoid surprise overages).

## Sales / demo strategy

- Lead with **order hub → mapping → BOH** in 10 minutes, then POS, then storefront.  
- Always show **integration honesty** and **recovery** — buyers forgive “not yet” if trust is high.

## Roadmaps (indicative)

### 30 / 60 / 90 days

- **30:** Stabilize triage tabs, webhook previews, RBAC denial tests, marketing headline alignment.  
- **60:** Pagination on hot lists, deeper Today cards, mapping confidence enforcement audits.  
- **90:** Inventory shortage blockers wired to real demand engine; expanded device modes.

### 6 months

- Deeper analytics + forecasting calibration; more channel connectors **for real**; enterprise export packs.

### 12 months

- Optional SSO/SCIM **if implemented**; advanced enterprise procurement artifacts.

---

## Remaining gaps (honest)

- **Product:** Enterprise procurement features, deeper labor, broader marketplace dispatch.  
- **Technical:** Pagination everywhere, background jobs observability at scale.  
- **UX:** Dense admin surfaces on small screens.  
- **Integrations:** Partner certifications and long-tail edge cases.  
- **Enterprise:** Formal compliance reports (only when attained).

## Commercial / enterprise readiness (qualitative ranges)

These are **not audited financial projections**.

- **Commercial MVP readiness:** ~70–85% (depends on connector set in your deployed env).  
- **Enterprise readiness:** ~40–60% without formal compliance reports and SSO/SCIM.  
- **Launch risk:** Medium — highest risks are **integration expectations** and **payments hardware** claims; mitigate with honest marketing + status model.

## Revenue potential

- **TODO: verify via web research** — size TAM/SAM for mid-market FoodOps bundles (2026 analyst notes). Do not invent market size numbers here.

## Hiring (if scaling)

- Head of **integrations** (partner engineering).  
- Senior **support + success** (FoodOps domain).  
- **Security** engineer part-time → full-time before enterprise push.

---

## TODO: verify via web research (manual)

1. Current **Toast** / **Square** / **Lightspeed** pricing pages and POS feature lists (2026).  
2. Whether **Deliverect** / **Cuboh** publish specific connector certifications relevant to your regions.  
3. **Restaurant365** vs **MarketMan** positioning changes post M&A activity (if any in 2025–2026).  
4. SOC2 / PCI marketing compliance language counsel recommends for your jurisdiction.
