# Supplier Marketplace setup (Era 191)

Era 191 certifies Supplier Marketplace wiring (Round 2): food, packaging, and equipment lanes with catalog browse and one-click reorder — with canonical proof via era116 live smoke.
...
| Script | Purpose |
|--------|---------|
| `npm run smoke:supplier-marketplace-era191` | Full era191 cert + wiring audit |
| `npm run test:ci:supplier-marketplace-era191` | Era191 + era116 + supplier marketplace unit tests |
| `npm run test:ci:supplier-marketplace-era191:cert` | Wiring cert only (CI gate) |
| `npm run smoke:supplier-marketplace-era116` | Canonical era116 smoke |
...
5. Run `npm run smoke:supplier-marketplace-era191` — artifact **PASSED**.
...
Summary written to `artifacts/supplier-marketplace-era191-smoke-summary.json` (gitignored).

See also: [supplier-marketplace-era116-setup.md](./supplier-marketplace-era116-setup.md)
