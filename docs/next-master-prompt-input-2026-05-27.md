# Next Master Prompt Input — OS Kitchen
...
| P0-2 | **CI bundle wiring** — focused bundles in default `quality` job | **Partially closed (Era 3 C4 + C8):** `test:ci:governance-bundles` + `test:ci:rbac-wave3` in `.github/workflows/ci.yml` |
