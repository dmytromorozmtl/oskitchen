...
**Related:** [`loi-design-partner-template.md`](./loi-design-partner-template.md) · [`founding-customer-story.md`](./founding-customer-story.md) · [`sales-safe-claims-registry.md`](./sales-safe-claims-registry.md) · [`pilot-execution-checklist.md`](./pilot-execution-checklist.md)
