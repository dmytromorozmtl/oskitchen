...
| Cron surface | `pilot-preflight.sh` PASS — `ENABLE_EXPERIMENTAL_CRONS` not `true`; 18 production crons only (`era9-cron-surface-recert-v1`, `era14-cron-surface-recert-v1`; `npm run smoke:cron-surface`) |
