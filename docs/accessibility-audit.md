...
## Absolute Final Task 147 — WCAG 2.1 AA certification

**Policy:** `absolute-final-wcag-21-aa-v1`  
**Cert test:** `tests/unit/absolute-final-wcag-21-aa-accessibility.test.ts`  
**Gate:** axe-core serious + critical violations = **0** on marketing, auth shell, and 10 key dashboard routes. Manual VoiceOver spot check on POS/KDS before enterprise pilot — automated scan is not a legal compliance certification.
