# Content Calendar — H2 2026

**Goal:** 2 posts/month minimum · Own "meal prep software" and "ghost kitchen POS" clusters  
**Owner:** Founder (until marketing hire)
...
| Week | Type | Title | Status |
|------|------|-------|--------|
| W1 | Case study | [Pilot 2] | ⬜ |
| W2 | Blog | Food waste variance reporting for operators | food cost tracking restaurant | ⬜ |
| W3 | Geo LP | Meal prep software NYC | ⬜ |
| W4 | LinkedIn | Founder build-in-public — 3×/week | ⬜ Ongoing |

---

## Distribution checklist (each publish)

- [ ] Submit URL in Google Search Console
- [ ] Share on LinkedIn (founder account)
- [ ] Link from relevant `/solutions/*` page
- [ ] Add internal link from `/blog` hub
