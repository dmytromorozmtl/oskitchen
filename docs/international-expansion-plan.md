...
**Related:** [`freemium-tier-plan.md`](./freemium-tier-plan.md) · [`soc2-readiness-assessment.md`](./soc2-readiness-assessment.md) · [`sso-scim-live-plan.md`](./sso-scim-live-plan.md) · [`STOREFRONT_I18N_NAV_FOOTER_FOUNDATION.md`](./STOREFRONT_I18N_NAV_FOOTER_FOUNDATION.md) · `lib/i18n.ts` · `lib/onboarding/onboarding-locale-options.ts`
...
| **Tax** | US-centric | UK VAT on digital services (advisor-led) |
