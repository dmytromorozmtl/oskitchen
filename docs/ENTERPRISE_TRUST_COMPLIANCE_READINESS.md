...
- SSO / SCIM, BYOK encryption, regional data residency ([`eu-data-residency-roadmap.md`](./eu-data-residency-roadmap.md)), formal SOC2 program ([`soc2-roadmap-with-timeline.md`](./soc2-roadmap-with-timeline.md)).
