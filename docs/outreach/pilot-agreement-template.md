...
**Pilot Period:** [Start Date] — [End Date] (3 months)  
**Pilot Price:** $[amount]/month (50% off standard pricing)

| Plan | Standard | Pilot price |
|------|----------|-------------|
| Starter | $29/mo | $15/mo |
| Pro | $79/mo | $40/mo |
| Team | $199/mo | $100/mo |
...
- Technical support (email + in-app support widget)
...
## Success criteria (optional — fill in together)
...
1. Create Stripe subscription with 50% coupon (or manual invoice for pilot period)
2. Schedule onboarding kickoff (see [pilot-program.md](../pilot-program.md) Week 1 timeline)
3. Add row to [pilot-tracker.md](pilot-tracker.md) → Pilot Deals Closed
4. Create workspace / invite operator to https://os-kitchen.com/signup if not already registered
