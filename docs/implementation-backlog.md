...
- Status: **permission_denied_packing_production_enforced**
- Decision: `era19-permission-denied-packing-production-v1` + `era19-permission-denied-page-access-v1` — page-level `packing.manage` / `production.manage` gates on 9 routes; no denial recovery loops; daily-service production queue unchanged
- Evidence: `lib/ux/permission-denied-era19-policy.ts`, `lib/ux/permission-denied-page-access-era19.ts`, wired packing/production pages + cert tests
...
- Module: Owner Daily Briefing / Kitchen / Packing QC
- Priority: P1 (WOW pillar — expo ↔ packing QC handoff honesty when priority lane active)
- Status: **briefing_kitchen_packing_qc_crosslink_wired**
- Decision: `era19-owner-daily-briefing-kitchen-packing-qc-v1` — handoff tile after KDS priority lane; `#packing-qc-clarity` deep link; packing-status rewire when aligned; no scanner certification claims
- Evidence: `lib/briefing/owner-daily-briefing-kitchen-packing-qc-era19.ts`, updated briefing service + kitchen pack
- Next: P0 proof unblock when ops credentials available, or permission-denied UX polish
...
- Module: Owner Daily Briefing / POS / Manager command center
- Priority: P1 (WOW pillar — shift supervisor ↔ register override supervision honesty)
...
- ID: `KOS-E19-030`
- Title: Era 19 Workstream E Cycle 30 — 4-step operator drill checklist + hero on production calendar
- Module: Production calendar / Operator drill / Kitchen prep
- Priority: P1 (operator speed — in-app drill without staging PASS or rush-hour claims)
...
- Module: Owner Daily Briefing / KDS / Owner command center
- Priority: P1 (WOW pillar — owner oversight ↔ kitchen priority lane honesty)
- Status: **briefing_owner_kds_priority_lane_crosslink_wired**
- Decision: `era19-owner-daily-briefing-owner-kds-v1` — real KDS queue load for owner role pack; priority lane tile + owner action link to `#kds-priority-lane-strip` when urgent; commercial actions stay higher priority
- Evidence: `lib/briefing/owner-daily-briefing-owner-kds-era19.ts`, updated briefing service + role pack + tile links
- Next: P0 proof unblock when ops credentials available, or POS manager override UX clarity
...
- Module: Owner Daily Briefing / KDS / Kitchen operator speed
- Priority: P1 (WOW pillar — kitchen command center ↔ priority lane honesty)
- Status: **briefing_kitchen_priority_lane_crosslink_wired**
- Decision: `era19-owner-daily-briefing-kitchen-v1` — real KDS queue load for kitchen role pack; priority lane tile + actions link to `#kds-priority-lane-strip`; kds-pressure rewired when lane active
- Evidence: `lib/briefing/owner-daily-briefing-kitchen-era19.ts`, updated briefing service + role pack + tile links
- Next: P0 proof unblock when ops credentials available, or POS manager override UX
...
### KOS-E18-055 — Platform workspace go-live section (P0)
- ID: `KOS-E18-055`
- Title: Era 18 Workstream O Cycle 55 — workspace detail launch projects + session-aware tenant review
- Module: Go-live / Platform ops
- Priority: P0 (pilot deployment speed — workspace → tenant launch validation)
- Status: **platform_workspace_go_live_section_wired**
- Decision: `era18-platform-workspace-go-live-focus-v1` — workspace detail panel with support session gate + impersonation deep link; MFA unchanged in production
...
- Module: Go-live / Integrations
- Priority: P0 (launch validation parity with live proof operator arc)
- Status: **go_live_channel_pilot_gate_wired**
- Decision: `era18-go-live-channel-pilot-focus-v1` — HIGH_RISK blocker + required readiness signal; WARNING for engineering live smoke pending; does not claim live PASS
- Evidence: `lib/go-live/go-live-channel-pilot-focus-era18.ts`, `services/go-live/go-live-service.ts`, `tests/unit/go-live-channel-pilot-focus-era18.test.ts`
- Next: Ops configures channel smoke env vars; run `npm run smoke:woo-shopify-live` for proof_passed artifact
...
- Module: Integrations / Commercial proof
- Priority: P0 (live Woo/Shopify proof operator path — honest engineering smoke posture)
- Status: **integration_health_live_proof_operator_wired**
- Decision: `era18-integration-health-live-proof-focus-v1` — pilot wizard gaps + in-app ready / engineering smoke pending; does not claim live PASS
- Evidence: `lib/integrations/integration-health-live-proof-focus-era18.ts`, `components/dashboard/channel-live-proof-status-panel.tsx`, `app/dashboard/integration-health/page.tsx`
- Next: Ops configures channel smoke env vars; run `npm run smoke:woo-shopify-live` for proof_passed artifact
...
- Module: Packing verification / Fulfillment
- Priority: P1 (fulfillment spine + operator speed)
- Status: **packing_verify_focus_attention_wired**
- Decision: `era18-packing-verify-focus-v1` — flagged lines, allergen checks, open sessions, failed scans prioritization; row next actions on verify console
- Evidence: `lib/packing-verification/packing-verify-focus-era18.ts`, `components/packing-verification/packing-verify-attention-strip.tsx`, `components/dashboard/packing-verify-console.tsx`
- Next: P0 staging proof ops execution when vault ready
...
- Module: Production / Kitchen ops
- Priority: P1 (production visibility + operator speed)
- Status: **production_board_focus_attention_wired**
- Decision: `era18-production-board-focus-v1` — late/hold/station overload prioritization; row next actions on board and prep list
- Evidence: `lib/production/production-board-focus-era18.ts`, `components/production/production-board-attention-strip.tsx`, `components/dashboard/production-command-center.tsx`
- Next: P0 staging proof ops execution when vault ready

### KOS-E18-029 — Go-live blocker attention strip (P1)
- ID: `KOS-E18-029`
- Title: Era 18 Workstream L Cycle 29 — launch blocker prioritization + validation row next actions
- Module: Go-live / Pilot deployment
- Priority: P1 (pilot deployment speed + commercial readiness)
- Status: **go_live_focus_attention_wired**
- Decision: `era18-go-live-focus-v1` — critical/high-risk blocker ordering; legacy checklist strip; blocker row next actions on project validation report
- Evidence: `lib/go-live/go-live-focus-era18.ts`, `components/dashboard/go-live/go-live-attention-strip.tsx`, `app/dashboard/go-live/page.tsx`, `app/dashboard/go-live/projects/[projectId]/page.tsx`
- Next: P0 staging proof ops execution when vault ready
...
- Next: P0 staging proof ops execution when vault ready; go-live blocker attention strip — **done** (KOS-E18-029)
...
- Module: POS / Shifts
- Priority: P1 (operator speed + financial clarity)
...
- Next: P0 staging proof ops execution when vault ready; POS shift close variance UX polish — **done** (KOS-E18-027)
...
- Next: Platform system health parity — **done** (KOS-E18-023); live Woo/Shopify proof when credentials available
...
- Module: POS
- Priority: P1 (financial clarity / bookkeeper workflows)
- Status: **shift_close_history_range_wired**
- Decision: `era18-pos-shift-close-history-range-v1` — URL `?range=` on shifts page; export respects same range
- Evidence: `lib/pos/pos-shift-close-history-range-era18.ts`, `components/dashboard/pos-shift-close-history-range-filter.tsx`
- Next: P0 staging proof ops execution (cannot fake PASS)
...
- Module: POS
- Priority: P1 (shift financial clarity)
...
- Next: P0 staging proof ops execution (cannot fake PASS); date-range filter wired in KOS-E18-012
