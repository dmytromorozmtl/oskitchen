...
**21 one-page battle cards (P1-85):** [`docs/competitor-battle-cards-index.md`](./competitor-battle-cards-index.md) — Toast through MarginEdge · policy `competitor-battle-cards-p1-85-v1`
...
Each card follows four blocks:

| Block | Purpose |
|-------|---------|
| **WIN (them)** | Acknowledge where competitor is legitimately stronger — builds trust |
| **TRAP** | Claim that loses the deal if you say it — forbidden language |
| **REDIRECT (us)** | Qualified OS Kitchen wedge for our ICP (ghost kitchen, meal prep, commissary) |
| **CTA** | Demo, compare page, or design-partner LOI |

Pair with LAER from [`objection-handling.md`](./objection-handling.md) when objection is emotional.
...
| Block | Content |
|-------|---------|
| **They win** | Certified hardware (Toast Go), US restaurant field support, payments scale, xtraCHEF/Toast IQ brand, thousands of reference customers |
...
| Block | Content |
|-------|---------|
| **They win** | SMB signup friction, Reader ecosystem, Cash App brand, offline card (where offered), millions of sellers |
...
| Block | Content |
|-------|---------|
| **They win** | Established restaurant + retail install base, partner/hardware channels, proven multi-location deployments, LIVE integrations catalog |
...
| Block | Content |
|-------|---------|
| **They win** | Aggregator menu sync to Uber Eats / DoorDash — core product, mature middleware category |
| **Trap** | "Deliverect parity" · "Native aggregator sync LIVE today" · "Replace Deliverect on day one" |
| **We redirect** | OS Kitchen **runs the kitchen** — production board, packing verification, owned storefront, in-browser POS · aggregator sync is **scaffold/roadmap** — disclose Integration Health SKIPPED |
| **ICP fit** | Operator needs **ops OS underneath** middleware — not middleware-only with mature POS elsewhere |
| **Talk track** | *"Deliverect routes orders to channels. We run production, packing, and owned preorder — many operators use middleware **with** an ops platform; we won't fake LIVE aggregator sync."* |
| **Compare** | [`/compare/deliverect`](/compare/deliverect) |
...
| Block | Content |
|-------|---------|
| **They win** | Best-in-class ecommerce, marketing, app ecosystem, merchant trust for online sales |
| **Trap** | "Replace Shopify entirely" · "Unified inventory LIVE cross-channel" · "Woo/Shopify integration production-certified" |
| **We redirect** | Kitchen system of record — production quantities from confirmed orders · packing by pickup window · KDS + POS in same tenant · Woo/Shopify **test shop** path (beta — live smoke required before LIVE claim) |
| **ICP fit** | Meal prep, ghost kitchen, commissary copying orders from Shopify into sheets daily |
| **Talk track** | *"Keep Shopify for marketing if you want — OS Kitchen is where orders become production tickets and packing labels. We don't claim unified inventory depletion today."* |
| **Compare** | [`/compare/meal-prep-software`](/compare/meal-prep-software) · Objection O2 in [`objection-handling.md`](./objection-handling.md) |
...
| Block | Content |
|-------|---------|
| **They win** | $0 software cost, no migration, team knows Google Sheets, flexible for tiny volume |
| **Trap** | "Guaranteed savings in 30 days" · "You'll definitely save $X" · "Zero learning curve" |
| **We redirect** | Quantify **mistake cost** and **admin hours** — [`roi-calculator-conservative.md`](./roi-calculator-conservative.md) at 35%/40% caps · phased pilot scope · CSV import path · design partner LOI |
| **ICP fit** | Upgrade when mispacks/refunds cost customers — **stay on sheets** if under ~40 meals/week |
| **Talk track** | *"Spreadsheets work until error cost exceeds subscription. Our calculator is conservative — not a guarantee. Pilot Week 2 baseline is how we prove fit together."* |
| **Compare** | [`/compare/meal-prep-software`](/compare/meal-prep-software) · Objection O12 |

---

## Quick reference matrix

| ID | Competitor | They win on | Our wedge | Disqualify if |
|----|------------|-------------|-----------|---------------|
...
**Never** on calls, decks, or battle-card PDFs:

- We beat [competitor] on everything
- Replace [Toast/Square] overnight
- Deliverect / DoorDash / Uber Eats parity LIVE today
- Thousands of customers / market leader
- SOC 2 Type II / enterprise-ready day one
- Guaranteed savings or ROI
- Unified cross-channel inventory LIVE
- Rush-hour KDS certified

Lint: `lintBattleCardCopy` in [`competitive-battle-cards-policy.ts`](../lib/marketing/competitive-battle-cards-policy.ts).  
Run `MARKETING_CLAIMS_STRICT=1 npm run verify-claims` before competitive decks.
...
| Doc | Use |
|-----|-----|
| [`competitor-comparison-honest.md`](./competitor-comparison-honest.md) | Full matrix + investor-safe summary |
