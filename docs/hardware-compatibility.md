...
**Blueprint guide (7 categories):** [`certified-hardware-guide.md`](./certified-hardware-guide.md) — iPad, printers, KDS, cash drawers, scanners, labels, terminals (`certified-hardware-guide-p2-86-v1`)
