...
**Free pilot tier:** First five qualified operators receive **90-day software waiver** (Pro/Team) per [`free-pilot-tier-program.md`](./free-pilot-tier-program.md) — founder gate required; **4 slots open** after LOI-DP-001.
