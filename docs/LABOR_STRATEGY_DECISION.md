...
**Non-goals:** payroll tax filing, jurisdictional labor law engine, full time-clock compliance — explicitly **not** marketed until implemented.

## Surfaces

- `/dashboard/staff`, `/dashboard/tasks`, `/dashboard/pos/shifts`  
- Hub: `/dashboard/reports/labor` (links + honest roadmap copy)
