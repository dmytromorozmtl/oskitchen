...
> Thanks for connecting. Quick question: where do Woo or Shopify orders land today before the line cooks see them?  
> We bundled Order hub + kitchen production + packing labels for small teams. Open to sending a Loom if useful — zero prep on your side.

## Cold email (short)

**Subject:** Fewer missed Shopify preorders?
...
1. Problem: spreadsheets + chat threads at cutoff time.
2. Show `/demo` import → Order hub rows + simulated channels.
3. Kitchen production checkboxes → packing export.
4. Ask: “Where do mismatched SKUs burn you?” → roadmap honesty.
...
- Day 3: Case study / screenshot.
- Day 7: Offer white-glove SKU mapping hour.
- Day 14: Close loop — archive politely.
