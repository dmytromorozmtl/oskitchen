...
type IntegrationAuditActor = WorkspacePermissionActor | null | undefined;
...
export async function logIntegrationPermissionDenied(
  actor: IntegrationAuditActor,
  input: {
  ...
  await auditLog({
    ...
    action: AUDIT_ACTIONS.INTEGRATION_PERMISSION_DENIED,
