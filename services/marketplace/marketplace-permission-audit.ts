...
type MarketplaceAuditActor = WorkspacePermissionActor | null | undefined;
...
export async function logMarketplacePermissionDenied(
  ...
  await auditLog({
    ...
    action: AUDIT_ACTIONS.MARKETPLACE_PERMISSION_DENIED,
