...
import {
  buildBriefingFirstNarrative,
  type BriefingFirstNarrativeSegments,
} from "@/lib/briefing/briefing-first-narrative";
...
export type OwnerDailyBriefingPayload = {
  ...
  briefingNarrative: BriefingFirstNarrativeSegments;
};
...
export async function loadOwnerDailyBriefing(
  ...
  const briefingNarrative = buildBriefingFirstNarrative({
    ordersToday: today.kpis.ordersToday,
    revenueToday: today.kpis.revenueToday,
    revenueWeek: today.kpis.revenueWeek,
    posTransactionsToday: today.kpis.posTransactionsToday,
